import { BarChart3, ClipboardList, FileSpreadsheet, FolderKanban, Gauge, Settings, ShieldCheck, Users, UserCheck, Wrench } from 'lucide-react';
import { NavLink } from 'react-router-dom';

const ADMIN_PATHS = ['/dashboard', '/fleet-assets', '/admin'];
